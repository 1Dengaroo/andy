...
const CLIPS = [
  { src: '/demo/clip-back.mp4', x: -28, rotate: -8, scale: 0.85, opacity: 0.6, z: 0 },
  { src: '/demo/clip-mid.mp4', x: 22, rotate: 6, scale: 0.9, opacity: 0.75, z: 1 },
  { src: '/demo/clip-front.mp4', x: 0, rotate: 0, scale: 1, opacity: 1, z: 2 }
] as const;
