---
name: code-cleanup
description: Guide for cleaning up code after iterative development -- removing dead code, eliminating duplicated logic, fixing convention violations, simplifying interfaces, and verifying documentation sync. Use after completing a feature or iterative session.
---
...
- `docs/TYPESCRIPT.md` -- No new patterns that should be documented
